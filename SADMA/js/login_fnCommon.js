...
{
	window.location="http://www.landaweb.local.com.ar/site_epostin/site/front/?userName="+userName;
};
...
var fnBeforeSendLoginForm = function()
{
	Pace.start();
};
...
function setLoginForm()
{
	...
	frmInfo[GLOBAL_FORM_FN_BEFORE_SUBMIT]= fnBeforeSendLoginForm;
